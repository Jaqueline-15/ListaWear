...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new ItemsList(R.mipmap.logo, "Stray Kids", "Stray Kids"));
        items.add(new ItemsList(R.mipmap.btss, "BTS", "BTS"));
        items.add(new ItemsList(R.mipmap.nct, "NCT", "NCT"));
        items.add(new ItemsList(R.mipmap.twice, "Twice", "Twice"));
